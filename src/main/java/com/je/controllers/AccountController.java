...
public class AccountController {
	...
	@PostMapping
	public Account CreateProduct(@RequestBody Account product) {
		return productService.createProduct(product);
	}
	
	@GetMapping("/fetch/{id}")
	public Account fetchProduct(@PathVariable Integer id) {
		return productService.fetchProduct(id);
	}
	
	@PutMapping("/update/{id}")
	public Account updateProduct(@PathVariable Integer id,@RequestBody Account product) {
